...
public class FragmentDom extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragments_dom,container,false);
        webView = (WebView) view.findViewById(R.id.webview_dom);
        webView.loadUrl("file:///android_asset/dom.html");
