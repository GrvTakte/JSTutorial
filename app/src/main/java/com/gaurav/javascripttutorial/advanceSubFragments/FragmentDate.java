...
public class FragmentDate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragments_date,container,false);
        webView = (WebView) view.findViewById(R.id.webview_date);
        webView.loadUrl("file:///android_asset/date.html");
