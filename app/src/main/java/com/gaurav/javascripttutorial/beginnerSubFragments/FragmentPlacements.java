...
public class FragmentPlacements extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_placements,container,false);
        webView = (WebView) view.findViewById(R.id.webview_placement);
