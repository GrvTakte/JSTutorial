...
public class FragmentIfelse extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragments_ifelse,container,false);
        webView = (WebView) view.findViewById(R.id.webview_if_else);
